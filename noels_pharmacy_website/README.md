...
- Premium responsive website, homepage, header and footer
...
Opening hours, public email, staff notification email and delivery settings are configurable after installation from **Noel's Online → Configuration → Website Settings**.

## Technical notes

- Odoo version: 19.0
- Addon version: 19.0.1.0.3
